...
namespace neturen\db\firebird;

/**
 *
 * @author Edgard Lorraine Messias <neturen@gmail.com>
 * @since 2.0
 */
class Connection extends \yii\db\Connection
{
     ...
     */
    public $schemaMap = [
        'firebird' => 'neturen\db\firebird\Schema', // Firebird
    ];

    /**
     * @inheritdoc
     */
    public $pdoClass = 'neturen\db\firebird\PdoAdapter';

    /**
     * @inheritdoc
     */
    public $commandClass = 'neturen\db\firebird\Command';
    /**
